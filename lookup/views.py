...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode +"&distance=5&API_KEY=82ACACE0-0D98-424A-AFB4-2FBDE500164C")
		...
		try:
			...
			api = "Error..."
	#https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=78230&distance=5&API_KEY=82ACACE0-0D98-424A-AFB4-2FBDE500164C
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=78230&distance=5&API_KEY=82ACACE0-0D98-424A-AFB4-2FBDE500164C")
